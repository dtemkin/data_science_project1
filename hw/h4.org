We have cleaned up data and have done basic visualization. Let move ahead with statistical analysis(remaining visualization, hypothesis testing etc.),
model building for prediction or for finding pattern. Please document your finding in the notebook. 

Points(10)
- For Growhosue project, finish KPI and build linear regression model for predicting revenue, boxes.
...
*Note: on 13th march there will be in class presentation and  project report is due on 13th march.*
